...
static CS_RETCODE clientmsg_cb(CS_CONTEXT *cs_ctx, CS_CONNECTION *cs_conn, CS_CLIENTMSG *cs_msg) {
    CS_CONTEXTObj *ctx;
...
static PyObject *CS_CONTEXT_cs_config(CS_CONTEXTObj *self, PyObject *args)
{
	...
	case OPTION_STRING:
	    str_value = PyUnicode_AsUTF8(obj);
	    if (PyErr_Occurred())
		return NULL;
...
static PyMemberDef CS_CONTEXT_memberlist[] = {
